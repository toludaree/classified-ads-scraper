...
class AdsSpider(CrawlSpider):
    ...
    def parse(self, response): 
        ...
        item.add_xpath("created_date", "//table[@class='listing-properties']//tr[td='Created:']/td[2]/text()")
        item.add_xpath("updated_date", "//table[@class='listing-properties']//tr[td='Updated:']/td[2]/text()")
        item.add_xpath("expires_date", "//table[@class='listing-properties']//tr[td='Expires:']/td[2]/text()")
        item.add_xpath("views", "//table[@class='listing-properties']//tr[td='Viewed:']/td[2]/text()")
